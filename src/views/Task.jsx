...
const Task = function Task() {
            ...
            render: (_, record) => {
                ...
                return (
                    <>
                        ...
                        {+state !== 2 ? (
                            <Popconfirm title='您确把此任务设置为完成吗？' onConfirm={updateHandle.bind(null, id)}>
    ...
    return (
        <div className='task-box'>
            ...
            {/* 表格 */}
            <Table columns={columns} dataSource={tableData} loading={tableLoading} pagination={false} rowKey='id' />
            ...
            <Modal
                ...
                onOk={submit}
            >
                <Form layout='vertical' initialValues={{ task: '', time: '' }} validateTrigger='onBlur' form={formIns}>
                    <Form.Item
                        label='任务描述'
                        name='task'
                        rules={[
